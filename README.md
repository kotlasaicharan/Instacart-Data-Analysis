...
## Objectives
- Analyze the anonymized [DATA](https://www.kaggle.com/datasets/yasserh/instacart-online-grocery-basket-analysis-dataset) of 3 million grocery orders from more than 200,000 Instacart users open-sourced by Instacart.
